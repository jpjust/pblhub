...
public class SessionDeleteDialogFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		builder.setMessage(R.string.session_delete_alert)
		.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int id) {
		    	...
		    	mDbHelper.deleteSession(Integer.parseInt(textId.getText().toString()));
		    	Toast.makeText(getActivity(), R.string.session_deleted, Toast.LENGTH_SHORT).show();    	
